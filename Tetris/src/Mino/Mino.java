...
public class Mino { // Super class for the Tetrominos

	public Block b[] = new Block[4];
	public Block tempB[] = new Block[4]; // designed for collision
	...
	public void update() {
		...
		// Move the mino
		if(KeyHandler.leftRotationPressed) { // Flips Left, case  = direction + 1
			switch(direction) {
			...
			KeyHandler.leftRotationPressed = false;
			GamePanel.se.play(3, false);
		}
		
		if(KeyHandler.rightRotationPressed) { // Flips Right, case = direction - 1
			switch(direction) {
			...
			KeyHandler.rightRotationPressed = false;
			GamePanel.se.play(3, false);
		}
		...
		if(KeyHandler.leftPressed) {
			...
			KeyHandler.leftPressed = false; // Gives that chittery movemnt to the blocks
		}
	...
	public void draw(Graphics2D g2) {
		...
		int margin = 2; // Adds a 2 pixel margin to all the blocks to the mino (To give it the tetris look)
		g2.setColor(b[0].c);
